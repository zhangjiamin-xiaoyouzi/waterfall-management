...
export const MOCK_AD_GROUPS: AdGroup[] = [
    ...
    adSources: [
      {
        ...
        ecpm: 14.56,
        thousandRequestValue: 0.56,
        requests: 120000,
        responses: 60000,
        responseRate: 50.0,
        bidWins: 20000,
        bidWinRate: 50.0,
        revenuePerThousand: 0.05,
        impressions: 26462,
        winImpressionRate: 100.0,
        clicks: 1058,
        ctr: 4.0,
        cpc: 0.96,
      ...
      },
      {
        ...
        bidWinRate: 50.0,
        isFallback: true,
        revenuePerThousand: 0.02,
        impressions: 15000,
        winImpressionRate: 99.5,
        clicks: 450,
        ctr: 3.0,
        cpc: 0.55,
        lastUpdated: '2024-01-15 10:30',
      ...
      },
      {
        ...
        pricingType: 'CPM',
        price: 5.5,
        estimatedRevenue: 1256.8,
        ecpm: 12.8,
        thousandRequestValue: 15.2,
        requests: 98200,
        responses: 78400,
        responseRate: 79.8,
        bidWins: 45200,
        bidWinRate: 46.0,
        revenuePerThousand: 0.03,
        impressions: 24580,
        winImpressionRate: 98.5,
        clicks: 892,
        ctr: 3.63,
        cpc: 0.82,
        lastUpdated: '2024-01-15 10:30',
      ...
      },
      {
        ...
        pricingType: 'bidding',
        price: 6.2,
        estimatedRevenue: 2103.5,
        ecpm: 15.6,
        thousandRequestValue: 18.5,
        requests: 134800,
        responses: 112600,
        responseRate: 83.5,
        bidWins: 67800,
        bidWinRate: 50.3,
        revenuePerThousand: 0.06,
        impressions: 28920,
        winImpressionRate: 99.8,
        clicks: 1205,
        ctr: 4.17,
        cpc: 1.05,
        lastUpdated: '2024-01-15 10:30',
      },
      {
        ...
        pricingType: 'CPM',
        price: 4.8,
        estimatedRevenue: 876.2,
        ecpm: 11.2,
        thousandRequestValue: 12.8,
        requests: 78200,
        responses: 58900,
        responseRate: 75.3,
        bidWins: 32100,
        bidWinRate: 41.1,
        revenuePerThousand: 0.04,
        impressions: 18500,
        winImpressionRate: 98.0,
        clicks: 680,
        ctr: 3.68,
        cpc: 0.78,
        lastUpdated: '2024-01-15 10:30',
    ...
    adSources: [
      {
        ...
        pricingType: 'bidding',
        price: 12.5,
        estimatedRevenue: 8560.32,
        ecpm: 18.25,
        thousandRequestValue: 0.68,
        requests: 98000,
        responses: 52000,
        responseRate: 53.06,
        bidWins: 18500,
        bidWinRate: 35.58,
        revenuePerThousand: 0.08,
        impressions: 42000,
        winImpressionRate: 100.0,
        clicks: 2100,
        ctr: 5.0,
      ...
      },
      {
        ...
        pricingType: 'CPM',
        price: 15.8,
        estimatedRevenue: 12890.45,
        ecpm: 16.78,
        thousandRequestValue: 0.72,
        requests: 145000,
        responses: 76800,
        responseRate: 52.97,
        bidWins: 0,
        bidWinRate: 0,
        revenuePerThousand: 0.07,
        impressions: 55000,
        winImpressionRate: 100.0,
        clicks: 2200,
        ctr: 4.0,
      ...
      },
      {
        ...
        pricingType: 'bidding',
        price: 8.9,
        estimatedRevenue: 5420.18,
        ecpm: 14.56,
        thousandRequestValue: 0.45,
        requests: 72000,
        responses: 37200,
        responseRate: 51.67,
        bidWins: 12400,
      ...
      },
      {
        ...
        pricingType: 'CPM',
        price: 6.2,
        estimatedRevenue: 1890.5,
        ecpm: 11.2,
        thousandRequestValue: 0.38,
        requests: 45000,
        responses: 28600,
        responseRate: 63.56,
        bidWins: 0,
  ...
  },
  {
    ...
    adSources: [
      {
        id: 'g2-source-1',
        name: 'MY-TapTap(iOS-图片)',
        status: 'enabled',
        pricingType: 'bidding',
        price: 18.5,
        estimatedRevenue: 15230.8,
        ecpm: 22.15,
        thousandRequestValue: 0.85,
        requests: 168000,
        responses: 95200,
        responseRate: 56.67,
        bidWins: 42100,
        bidWinRate: 44.21,
        revenuePerThousand: 0.09,
        impressions: 65000,
        winImpressionRate: 100.0,
        clicks: 3250,
        ctr: 5.0,
      ...
      },
      {
        ...
        pricingType: 'CPM',
        price: 20.0,
        estimatedRevenue: 18920.5,
        ecpm: 19.8,
        thousandRequestValue: 0.92,
        requests: 198000,
        responses: 115000,
        responseRate: 58.08,
        bidWins: 0,
      ...
      },
      {
        ...
        pricingType: 'bidding',
        price: 10.2,
        estimatedRevenue: 7850.25,
        ecpm: 15.6,
        thousandRequestValue: 0.58,
        requests: 88000,
        responses: 50300,
        responseRate: 57.16,
        bidWins: 18200,
      ...
      },
      {
        ...
        pricingType: 'CPM',
        price: 7.5,
        estimatedRevenue: 2340.8,
        ecpm: 12.45,
        thousandRequestValue: 0.42,
        requests: 52000,
        responses: 31200,
        responseRate: 60.0,
        bidWins: 0,
